...
public class Controller {
						...
						if (oldValue) {
							try {
								...
								if ((field == departureRadius && getValue(field) == grapher.getDepartureRadius())
									...
									return;
								drawSituation();
							} catch (NumberFormatException ignoredException) {} //Just don't draw!
						}
					}
				});
			}	
	...
	@FXML public Button startButton, trajectoryButton, radiusChartButton, velocityChartButton;
	@FXML public ToggleButton advancedButton;
	@FXML public TextField vBoost1, vBoost2, tBoost2, precision, endTime, departureRadius, arrivalRadius;
	@FXML public Label precisionLabel, endTimeLabel, departureRadiusLabel, arrivalRadiusLabel, cursorCoords, attemptsLeftLabel;
	@FXML public Text startErrorText;
	@FXML public Canvas trajectoryCanvas;
	@FXML public LineChart<Number, Number> radiusChart, velocityChart;
	@FXML public Pane graphsWrappingPane;
